...
const medicalTerms = {
  ...
  "injection": "Administration of a medication through a needle into tissue or the bloodstream, depending on route.",
  ...
  medication: "A drug used to prevent, diagnose, treat, or manage signs, symptoms, or disease processes.",
  "medication right": "One of the safety checks used in medication administration, such as right patient, drug, dose, route, and time.",
  ...
  "right documentation": "A medication administration safety principle requiring accurate recording after giving a medication.",
  "right dose": "A medication administration safety principle requiring verification that the ordered and prepared dose is appropriate.",
  "right route": "A medication administration safety principle requiring the medication to be given by the correct path, such as oral, IV, IM, or inhaled.",
  "right time": "A medication administration safety principle requiring administration at the correct scheduled time or interval.",
